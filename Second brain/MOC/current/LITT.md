...
# MOC - LITT
MOC [[MOC/NONE|NONE]] %% hashtags %% #moc #LITT [[_Assets/_Menu/_help/_def/Map of Content|?]] 
...
Notes rattachées à MOC/current/LITT

%%
dataview:
- Table avec les champs path, type, status
- Notes contenant un lien vers MOC/current/LITT
- Tri par path, name
%%
