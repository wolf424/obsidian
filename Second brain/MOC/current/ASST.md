...
# MOC - ASST
MOC [[MOC/NONE|NONE]] %% hashtags %% #moc #ASST [[_Assets/_Menu/_help/_def/Map of Content|?]] 
...
Notes rattachées à MOC/current/ASST

%%
dataview:
- Table avec les champs path, type, status
- Notes contenant un lien vers MOC/current/ASST
- Tri par path, name
%%

```dataview
table file.path, type, status
from [[MOC/current/ASST]] 
