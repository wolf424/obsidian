...
# MOC - TODO
MOC [[MOC/NONE|NONE]] %% hashtags %% #moc #TODO [[_Assets/_Menu/_help/_def/Map of Content|?]] 
...
Notes rattachées à MOC/current/TODO

%%
dataview:
- Table avec les champs path, type, status
- Notes contenant un lien vers MOC/current/TODO
- Tri par type, path, name
%%

```dataview
table file.path, type, status
from [[MOC/current/TODO]] 
